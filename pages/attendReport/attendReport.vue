<template>
	<view>
		<uni-view class="cu-bar bg-white solid-bottom">
			<uni-view class="action">
				<uni-text class="cuIcon-titles text-orange"><span></span></uni-text>月度考勤
			</uni-view>
			<uni-view class="action">
				<uni-switch class="">
					<div class="uni-switch-wrapper">
						<div class="uni-switch-input" style="background-color: rgb(223, 223, 223); border-color: rgb(223, 223, 223);"></div>
						<div class="uni-checkbox-input" style="color: rgb(0, 122, 255); display: none;"></div>
					</div>
				</uni-switch>
			</uni-view>
		</uni-view>
		<uni-view class="cu-card case">
			<uni-view class="cu-item shadow">
				<uni-view class="image">
					<view class="qiun-columns">
						<view class="qiun-bg-white qiun-title-bar qiun-common-mt">
							<view class="qiun-title-dot-light">一周统计</view>
						</view>
	...
	export default {
		...
		methods: {
			getCircleData() {
				...
				_self.showCircle("canvasRing", Ring);
				// },
				// 	fail: () => {
