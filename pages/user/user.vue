    ...
    <view class="container">  
		...
		>
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-dizhi" iconColor="#5fcda2" title="考勤地址" @click="navTo('/pages/address/address')"></list-cell>
				<list-cell icon="icon-share" iconColor="#9789f7" title="分享" tips="微信/QQ"></list-cell>
				<list-cell icon="icon-pinglun-copy" iconColor="#ee883b" title="最近沟通" tips="hr"></list-cell>
